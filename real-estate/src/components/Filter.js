...
function Filter() {
    ...
    return (
        <div className='bg-white h-[fit] py-4 lg:py-4 mt-4 px-2 lg:px-0 border flex lg:justify-around  '>

            <div className="filters flex items-center justify-start  gap-x-2 lg:gap-x-10">
                <div onClick={ToggleHouse} className="filter  px-2 lg:px-5 w-[120px] lg:w-[180px] hover:shadow-sm border py-3 rounded-md flex items-center justify-around lg:justify-between relative cursor-pointer">
                ...
                <div onClick={SortWithPricing} className="filter px-2 lg:px-5 w-[120px] lg:w-[180px] hover:shadow-sm border py-3 rounded-md flex items-center justify-around lg:justify-between relative cursor-pointer">
                ...
                <div onClick={SmartSorting} className="filter  px-1 lg:px-5 w-[120px] lg:w-[180px] hover:shadow-sm border py-3 rounded-md flex items-center justify-around lg:justify-between relative cursor-pointer">
            ...
            <FunnelIcon className='text-lime-500 w-6 funnel hidden lg:flex ml-4' />
        </div>
    )
}
