...
function Search() {
  return (
    <div className='flex flex-col justify-center items-center absolute lg:top-[40%]  lg:left-[10%] lg:right-[10%] z-[40] '>
      <h1 className='  text-white md:text-5xl lg:text-6xl text:shadow-xl font-bold lg:mt-[-170px] 2xl:mt-[-80px] lg:max-w-[700px] text-center '>Your dream home is here!</h1>
