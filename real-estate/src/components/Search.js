    ...
    <div className='flex flex-col justify-center items-center absolute lg:top-[40%]  lg:left-[10%] lg:right-[10%] z-[40] '>
      ...
      <span className='relative'>
        ...
        <input type="search "
          ...
          className=' px-10 py-2 md:mt-12 rounded-full placeholder:text-[12px] placeholder:pl-2 lg:placeholder:pl-2 lg:w-[500px] lg:placeholder:text-md lg:px-14 focus:outline-none focus:opacity-90'
