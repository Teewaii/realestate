  ...
  return (
    <>
      ...
      {cardata.map(({ pix, id, price, state, str, city, bed, bath, size, time }) => (
        ...
        <Link key={id} to={`/${id}`} className="card bg-white shadow-lg rounded-lg h-[fit] pb-4  sm:h-[340px] lg:h-fit lg:pb-4 w-[90%] md:w-[225px] lg:w-[285px] xl:w-[270px] 2xl:w-[250px] cursor-pointer hover:shadow-xl hover:scale-105 duration-300 ease-in-out">
