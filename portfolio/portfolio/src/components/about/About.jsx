  ...
  return (
    ...
    ' >
        <div className="desc text-left flex-[1]">
          <h2 className=" text-[white] text-[30px]  dark:text-primary">About <span className='text-secondary dark:text-dark font-bold' >me!</span></h2>
      ...
      border-b-[1px] border-lightprim pb-[30px] md:text-[15px] 2xl:text-[19px] 2xl:leading-[38px]
        ...
        '>Hi, I’m Taiye and I love building software products & services that promotes business and economic growths with great user experience and accessibility. <br /><br />
            ...
            <span className='text-secondary dark:text-dark font-bold'> Over the last 10 years</span> I have worked in both the advertising and IT industry through which I have been able to demonstrate exceptional skills in graphic/product design, people management, web development and efficient problem solving.<br /> <br />
