...
export default function Mode_mob({ dark_mode, DarkMode }) {
  return (
    <div className='mode cursor-pointer tool  group absolute  top-[4.5%] left-[70%] S
     md:relative md:hidden
      ...
      {dark_mode ?
        ...
        <MoonIcon className='w-[28px] md:w-[28px] fill-primary dark:fill-secondary animate-pulse' />}
    </div>
  )
}
