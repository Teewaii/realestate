...
export default function Btn() {
  return (
    <div className='relative w-fit' >
      <button className='flex group flex-row-reverse text-[20px] gap-2 md:gap-3 items-center rounded-[10px] py-[15px] 
      ...
      duration-300 bg-primary hover:bg-secondary  hover:text-primary '><span className='animate-pulse -rotate-45 group-hover:rotate-0 '><svg width="20" height="25" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
