            ...
            <section className='hero relative bg-hero-right-mob  bg-contain bg-right-top bg-no-repeat  
            md:bg-hero-right-lg md:h-[85vh]
            '>
                <div className='bucket container pt-[45px] text-[17px]
                md:pt-[145px] md:flex md:h-[100vh] md:items-start justify-center
                '>
                  <div className="desc text-left md:flex-[1.7]">
                    ...
                    md:text-[50px]   xl:text-[60px] md:leading-[3.5rem] xl:leading-[5rem] lg:after:h-[12px] md:max-w-[600px]  xl:max-w-[650px] md:after:bottom-[7px] xl:after:bottom-[11px] 
