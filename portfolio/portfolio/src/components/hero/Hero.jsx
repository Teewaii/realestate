...
export default function Hello() {
  return (
    ...
    <section className='hero  relative bg-hero-right-mob pt-[120px] bg-contain bg-right-top bg-no-repeat overflow-hidden
            lg:bg-hero-right-lg dark:bg-none lg:h-[70vh] xl:h-[95vh]  xl:pt-[80px] 
      ...
      <div className='bucket container pt-[35px] text-[17px]
        ...
        <div className="desc text-left lg:flex-[1.7]  overflow-x-hidden">
          ...
          mb-[20px] dark:z-[2] md:text-[68px] 2xl:text-[80px] md:leading-[4.5rem] 2xl:leading-[5rem] lg:after:h-[12px] md:max-w-[650px] 
           2xl:max-w-[750px] md:after:bottom-[7px] 2xl:after:bottom-[11px] 
          dark:text-[white]
        ...
        <div className="img lg:flex lg:flex-col lg:items-center lg:flex-[1.1] lg:bg-hds lg:bg-no-repeat lg:h-[100%]
                  lg:bg-center-top lg:bg-contain   mt-[30px] 
                  ">
